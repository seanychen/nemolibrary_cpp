...
## test 01-2
echo "test 02: mytest.txt motif:4 random:1000 undirected" >> result.txt
echo "test 02: mytest.txt motif:4 random:1000 undirected" 
./nemolib test_samples/mytest.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/mytest.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/mytest.txt 4 1000 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
...
## test 01-4
echo "test 04: mytest.txt motif:4 random:1500 undirected" >> result.txt
echo "test 04: mytest.txt motif:4 random:1500 undirected" 
./nemolib test_samples/mytest.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/mytest.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/mytest.txt 4 1500 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
echo "------------------------------------------------------------------" >> result.txt
...
## test 02-2
echo "test 02: MIPS_index.txt motif:4 random:1000 undirected" >> result.txt
echo "test 02: MIPS_index.txt motif:4 random:1000 undirected" 
./nemolib test_samples/MIPS_index.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/MIPS_index.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/MIPS_index.txt 4 1000 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
...
## test 02-4
echo "test 04: MIPS_index.txt motif:4 random:1500 undirected" >> result.txt
echo "test 04: MIPS_index.txt motif:4 random:1500 undirected" 
./nemolib test_samples/MIPS_index.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/MIPS_index.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/MIPS_index.txt 4 1500 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
echo "------------------------------------------------------------------" >> result.txt
...
## test 02-2
echo "test 02: Dmela20160430_idx.txt motif:4 random:1000 undirected" >> result.txt
echo "test 02: Dmela20160430_idx.txt motif:4 random:1000 undirected" 
./nemolib test_samples/Dmela20160430_idx.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/Dmela20160430_idx.txt 4 1000 0 | grep -i "Time" >> result.txt
./nemolib test_samples/Dmela20160430_idx.txt 4 1000 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
...
## test 03-4
echo "test 04: Dmela20160430_idx.txt motif:4 random:1500 undirected" >> result.txt
echo "test 04: Dmela20160430_idx.txt motif:4 random:1500 undirected" 
./nemolib test_samples/Dmela20160430_idx.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/Dmela20160430_idx.txt 4 1500 0 | grep -i "Time" >> result.txt
./nemolib test_samples/Dmela20160430_idx.txt 4 1500 0 | grep -i "Time" >> result.txt
echo "" >> result.txt
echo "------------------------------------------------------------------" >> result.txt
